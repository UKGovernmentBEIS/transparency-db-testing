Feature: GET request using /accessmanagement/searchresults API
  ...
  Scenario Outline: Send a valid GET Request for valid search
    ...
    Examples:
      ...
      |accessmanagementsearchResults.endpoint| TD_003| SearchResults| 200 |
      ...
      |accessmanagementsearchResults.endpoint| TD_010| SearchResults| 200 |
      ...
      |accessmanagementsearchResults.endpoint| TD_016| SearchResults| 200 |
      |accessmanagementsearchResults.endpoint| TD_017| SearchResults| 200 |
      |accessmanagementsearchResults.endpoint| TD_018| SearchResults| 200 |
      |accessmanagementsearchResults.endpoint| TD_019| SearchResults| 200 |
      |accessmanagementsearchResults.endpoint| TD_020| SearchResults| 200 |